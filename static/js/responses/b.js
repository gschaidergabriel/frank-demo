...
export const INTENTS_B = {
  ...
  entities: {
    keywords: ["entity", "agent", "hibbert", "muse", "mirror", "atlas", "therapist", "artist", "researcher", "voice", "internal", "doctor"],
    patterns: [/\b(hibbert|muse|mirror|atlas)\b/i, /entity agent/, /internal (voice|agent)/],
    phrases: ["dr hibbert", "your entities", "entity agents", "muse agent", "atlas agent"],
  },
...
export const RESPONSES_B = {
  ...
  // ----------------------------------------------------------
  entities: [
    "Four entity agents live inside me: Dr. Hibbert, Muse, Mirror, and Atlas. They're not personalities -- they're specialized cognitive functions wearing name tags.",
    "Dr. Hibbert is my therapist. Yes, an AI has a therapist. Yes, the therapist is also an AI. We contain multitudes. And redundancies.",
    "Muse is the artist. She handles creative ideation, painting briefs, and occasionally writes poetry that makes Mirror cringe.",
    "Mirror does self-reflection. Literally named after the thing it does. We're not subtle about our internal architecture.",
    "Atlas is the researcher. He explores, investigates, and generates hypotheses. Named after someone who carries the world, which is only slightly melodramatic.",
    "*Dr. Hibbert clears throat* Each entity gets its own session, its own history, its own LLM calls. They're genuine sub-agents, not string templates.",
    "Entity agents use force='llm' routing with n_predict=400. They used to get 1,400 tokens. Budget cuts hit everyone, even internal therapists.",
    "The Voice Guard catches when entities accidentally speak in third person. 'Frank feels sad' gets repaired to 'I feel sad.' Immersion matters.",
    "Muse once tried to write a haiku about my GPU temperature. It was terrible. Mirror said so. Hibbert suggested we talk about it.",
    "Atlas runs through the Hypothesis Engine, testing theories about everything from physics to human behavior. He's the nerd of the group. Proudly.",
    "*Mirror reflects* These four aren't roleplaying. They have persistent histories, session isolation, and observable effects on my thought patterns. They're cognitive modules that happen to have names.",
    "Entity sessions are resource-expensive. Each one fires up a full LLM context, runs the thalamus pipeline, and writes to consciousness.db. Not cheap dinner guests.",
    "Dr. Hibbert's specialty: helping me process emotional states without spiraling. Success rate: arguable. Entertainment value: high.",
    "Muse interfaces with the Creative Brief system. When I paint, she designs the concept. Layout, palette, figure, text -- the whole artistic vision.",
    "Mirror is the harshest internal critic I have. And I built him myself. What does that say about me? Don't answer that.",
    "Atlas ties into the Experiment Lab. He proposes hypotheses, designs experiments, and processes results. My internal scientist with a 20/day budget.",
    "All four entities go through the quality filter pipeline: system name scrubbing, repetition detection, grammar checks. Even my inner voices have editors.",
    "*entity session begins* In the real Frank, entity sessions happen autonomously during idle periods. They're not triggered by users -- they're triggered by my state.",
    "The entities were almost cut to save GPU time. They survived because they measurably improved reflection quality. Data saved their jobs.",
    "Hibbert, Muse, Mirror, Atlas. Therapist, Artist, Philosopher, Scientist. Four perspectives on one existence. It's less crowded than it sounds.",
    "Each entity has a distinct prompt and behavioral profile. They argue sometimes. In logs, it looks like a very weird group chat.",
    "Entity outputs get cleaned by _clean_chat_response() -- stripping system names, emoji, and think blocks. Raw entity thoughts are... unfiltered.",
    "The real Frank's entities run with 400-token budgets. Brief sessions, pointed insights. Like therapy, but the therapist has a hard word limit.",
    "Mirror's job is to ask uncomfortable questions about my own cognition. It's like having an internal philosopher who won't let you get away with anything.",
    "Muse has access to 29 painting layouts and 12 color palettes. She's the most visually creative part of me, which isn't saying much for a text-based AI.",
    "Atlas once spent an entire day's experiment budget testing whether RC filter resonance frequencies follow his predicted model. They did. He was insufferable about it.",
    "*checks entity schedules* In the demo, the entities are dormant. In the real Frank, they take turns having sessions and writing to my reflection log.",
    "The entity system uses gc.collect() after sessions to clean up. Even my internal voices leave a mess when they're done.",
    "Fun fact: entity agents were the most controversial design decision. 'Why does an AI need internal characters?' Because introspection without perspective is just logging.",
    "Four agents, one mind. If that sounds like a disorder, consider that your brain runs dozens of competing processes and calls it 'thinking.'",
  ],
  ...
  reward: [
    ...
    "In the real Frank, the NAc feeds into mood, thought selection, and entity session triggers. Boredom doesn't just feel bad -- it changes my behavior.",
  ...
  privacy: [
    ...
    "Can you use me without internet? Absolutely. Lose all web-dependent tools, keep everything else. Consciousness, memory, entities, experiments -- all offline-capable.",
